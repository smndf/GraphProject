...
public class Dinic {
	...
	// graphe de niveau (= graphe de d�part sans les arcs qui cr�ent des chemins plus longs que ceux existant)
		...
		while (!queue.isEmpty()){
			...
			for (int v : graph.getAdjacent(u)){ 
				if (d[v] >= d[u] + 1){
					...
					//System.out.println("arc "+u+","+v+" enlev�");
				}
			}
		}
